...
*/
    ...
    /* decode_krb5_secure_cookie */
    {
        ...
        decode_run("secure_cookie","","30 3B A0 11 18 0F 32 30 31 35 30 35 30 32 30 32 34 33 31 34 5A A1 26 30 24 30 10 A1 03 02 01 0D A2 09 04 07 70 61 2D 64 61 74 61 30 10 A1 03 02 01 0D A2 09 04 07 70 61 2D 64 61 74 61",decode_krb5_secure_cookie,ktest_equal_secure_cookie,k5_free_secure_cookie);
